...
| Eng temp too high 248*F           | A warning message when the engine coolant temperature is too high (above 120*C / 248*F)                            |
| Oil temp too high 275*F           | A warning message when the engine oil temperature is too high (above 135*C / 275*F)                                |
