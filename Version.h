...
const float g_Version   = 1.7f; // Add warnings about engine oil and engine temp too high, as well as some minor potential timeout errors for the CAN frame communications
#endif